  ...
  template: `
    <div class="car-container">
      <svg viewBox="0 0 100 200" class="car-svg">
        ...
        <ellipse cx="16" cy="10" rx="6" ry="12" fill="#fef08a" opacity="0.25" filter="blur(3px)" transform="rotate(-15 16 10)" />
        
        <!-- Farol Direito -->
        <path d="M 88,12 C 84,12 76,15 77,22 C 82,22 88,18 88,12 Z" fill="url(#headlightGradient)" stroke="#f59e0b" stroke-width="0.5" />
        <ellipse cx="84" cy="10" rx="6" ry="12" fill="#fef08a" opacity="0.25" filter="blur(3px)" transform="rotate(15 84 10)" />
